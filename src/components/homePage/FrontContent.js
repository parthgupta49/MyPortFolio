        ...
        <motion.div
            ...
            <div className='flex  justify-between flex-col md:flex-row image-container:items-center image-container:gap-10'>
                ...
                <div className='flex flex-col gap-5 justify-center image-container:self-start'>
                    ...
                    <Link to={RESUME_DRIVE_LINK} target='_blank' className="w-fit font-semibold relative inline-flex items-center justify-start px-6 py-3 overflow-hidden transition-all bg-yellow-100 rounded-lg hover:bg-yellow-100 group">
